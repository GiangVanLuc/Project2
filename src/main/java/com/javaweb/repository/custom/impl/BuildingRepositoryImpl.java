...
//		Query query = entityManager.createQuery(sql, BuildingEntity.class);
		...
		queryNomal(buildingSearchBuilder, where); // Ham xu ly cac query lay cac field trong building
		querySpecial(buildingSearchBuilder, where); // Ham xu ly cac query >=, <=, Phuc tap
